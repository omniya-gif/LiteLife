...
-- Insert some default badges with updated icon URLs
INSERT INTO badges (name, description, icon, cost, category, requirements) VALUES
  ('Early Bird', 'Complete 5 morning workouts', 'https://img.icons8.com/pulsar-color/96/sunrise.png', 100, 'fitness', '{"min_workouts": 5}'),
  ('Nutrition Master', 'Log 50 healthy meals', 'https://img.icons8.com/pulsar-color/96/healthy-food.png', 200, 'nutrition', '{"min_healthy_meals": 50}'),
  ('Zen Master', 'Complete 10 hours of meditation', 'https://img.icons8.com/pulsar-color/96/yoga.png', 300, 'wellness', '{"min_meditation_minutes": 600}'),
  ('Workout Warrior', 'Complete 20 workouts', 'https://img.icons8.com/pulsar-color/96/strength.png', 400, 'fitness', '{"min_workouts": 20}'),
  ('Health Pioneer', 'First badge achievement', 'https://img.icons8.com/pulsar-color/96/medal.png', 50, 'wellness', '{}')
