      ...
      {mode === 'manual' ? (
        ...
        >
          <View className="mb-12 items-center">
            <View className="h-32 w-32 items-center justify-center rounded-full" style={{ backgroundColor: `${theme.primary}10` }}>
              <Droplets size={48} color={theme.primary} />
              <Text className="mt-2 text-2xl font-bold text-white">
                {waterTarget} ml
              </Text>
              <Text className="text-gray-400">{formatLiters(waterTarget)}L • {formatGlasses(waterTarget)} glasses</Text>
            </View>
          </View>
          ...
          <View className="mt-8 flex-row justify-between">
            {[1500, 2000, 2500, 3000].map((preset) => (
              <TouchableOpacity
                ...
                style={waterTarget === preset ? { backgroundColor: `${theme.primary}20`, borderWidth: 1, borderColor: theme.primary } : {}}
              >
        ...
        >
          <View className="mb-8 h-32 w-32 items-center justify-center rounded-full" style={{ backgroundColor: `${theme.primary}10` }}>
            ...
            {autoWater && (
              <View className="mt-4">
                ...
                <Text className="text-center text-gray-400">{formatLiters(autoWater)}L • {formatGlasses(autoWater)} glasses</Text>
              </View>
            )}
          </View>
