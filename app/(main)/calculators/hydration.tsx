...
export default function HydrationTracker() {
  ...
  const fetchHydration = async () => {
    ...
    if (!user?.email) {
      console.log('⚠️ Cannot fetch hydration - user email not available yet');
      setIsLoading(false);
      return;
    }
    ...
    try {
      ...
      const water = await readHydrationData(startOfDay.toISOString(), endOfDay.toISOString(), user.email);
